<h1 align="center">Hi 👋, I'm Pierre Barba</h1>
...
const softwareDeveloper = {
  ...
  frontEnd: ["JavaScript","Redux", "SASS", "CSS3", "Bootstrap"],
  backEnd:["Ruby", "Rails", "SQL"],
  loveTo: "I love knowing about what's behind each app and all the world of opportunities you have when you're learning to code.",
  letsTalkAbout: [["NFL", "F1", "VideoGames" ], "Music", "DeliciousFood", "WorkingOut"],
  experience:"Remote pair-programming with international developers",
  funFact: "if you can eat more tacos than me I'll buy you a coffee",
  loveMoreThanCode: "My family and my friends"
}
